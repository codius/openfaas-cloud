...
function replaceTokens(content, isSignedIn, claims) {
    const { base_href, public_url, pretty_url, query_pretty_url, github_app_url, payment_pointer } = process.env;
    ...
    replaced = replaced.replace(/__PAYMENT_POINTER___/g, payment_pointer);
